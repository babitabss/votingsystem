...
$sql = "SELECT id, first_name, last_name, email, phone,votes FROM candidates WHERE election_type = 'President'";
...
<div class="container mt-5">
    <h2 class="mb-4">President Election Candidates</h2>
    <div class="row">
        <?php
        if ($result->num_rows > 0) {
            ...
            echo '<p>No candidates registered for the President election.</p>';
        }
        $conn->close();
        ?>
    </div>
